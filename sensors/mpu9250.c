...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
	...
	// 0. READ THE 14 REGISTERS FROM SENSOR TO THE ARRAY rawData
	...
	int16_t data0 = (rawData[0] << 8 | rawData[1]);
	data[0] = data0;
	int16_t data1 = (rawData[2] << 8 | rawData[3]);
	data[1] = data1;
	int16_t data2 = (rawData[4] << 8 | rawData[5]);
	data[2] = data2;
	
	int16_t data3 = (rawData[6] << 8 | rawData[7]);
	data[3] = data3;
	
	int16_t data4 = (rawData[8] << 8 | rawData[9]);
	data[4] = data4;
	int16_t data5 = (rawData[10] << 8 | rawData[11]);
	data[5] = data5;
	int16_t data6 = (rawData[12] << 8 | rawData[13]);
	data[6] = data6;
	...
	*az = (float)data[2]*aRes - accelBias[2];
	...
	// 4. CALCULATE THE GYRO VALUES FROM ARRAY data INTO ACTUAL DEGREES PER SECOND
